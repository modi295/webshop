...
function ChangePassword() {
    ...
    const [reenterPassword, setrepwd] = useState('')

    function updatepassword() {

        let item = { userId, secretQuestion, sqAnswer, password, reenterPassword }
        console.warn("item", item)
        fetch(`http://localhost:44354/api/Customer/updatePassword/${userId}`, {
            method: 'PUT',
            headers: {
                ...
                <div className="container">
                    <div className="col-xl-9">
                        ...
                        <div className="row">
                            ...
                            <div className="col-md-4">
                                <input type="text" className="form-control" onChange={(e) => { setrepwd(e.target.value); }} required></input>
                            </div>
                        </div>
                    </div>
                </div>
